...
**If no spec exists yet** (e.g., the feature hasn't been through the
pipeline), skip the sync and note: "This change isn't covered by a spec
yet — consider running the pipeline to document it."
