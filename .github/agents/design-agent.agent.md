...
### Step 8: Sync
Run `/speckit.sync` to reverse-sync any visual or behavioral code changes
back into spec.md and plan.md. This enforces **Article 5 (Spec Sync)**.
Runs automatically as a post-implement hook (see `.specify/extensions.yml`).
